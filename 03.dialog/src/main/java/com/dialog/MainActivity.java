...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    DialogInterface.OnMultiChoiceClickListener multiDialogListener = new DialogInterface.OnMultiChoiceClickListener() {
        @Override
    ...
    public void onClick(View v) {
        if(v==alertBtn){
            ...
            builder.setMultiChoiceItems(R.array.dialog_array, test, multiDialogListener);
